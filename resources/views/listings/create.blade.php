<x-layout>
    <x-card class="max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/listings" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="job" class="inline-block text-lg mb-2">Job Title</label>
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="job" placeholder="Example: Senior Laravel Developer" value="{{old('job')}}" />
                @error('job')
                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
